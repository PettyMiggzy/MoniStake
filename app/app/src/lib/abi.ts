...
export const stakingAbi = [
  ...
  { type: "function", name: "stake", stateMutability: "nonpayable", inputs: [{ type: "uint256" }, { type: "uint16" }], outputs: [] },
  { type: "function", name: "unstake", stateMutability: "nonpayable", inputs: [{ type: "uint256" }], outputs: [] },
  { type: "function", name: "claim", stateMutability: "nonpayable", inputs: [], outputs: [] },

  { type: "function", name: "addRewards", stateMutability: "nonpayable", inputs: [{ type: "uint256" }], outputs: [] },
